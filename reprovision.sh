...
curl -L -o j4im.jar https://github.com/mapio/j4im/releases/download/0.4.1-beta/j4im-0.4.1-beta.jar >/dev/null 2>&1
...
( curl -L -o /tmp/j4im.zip https://github.com/mapio/j4im/releases/download/0.4.1-beta/j4im-0.4.1-beta-javadoc.zip && unzip /tmp/j4im.zip && mv j4im-0.4-beta-javadoc j4im ) >/dev/null 2>&1
